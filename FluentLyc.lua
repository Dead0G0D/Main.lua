...
local Themes = {
	...
	LycHubv1 = {
		...
		ElementBorder = Color3.fromRGB(0, 0, 0),
		InElementBorder = Color3.fromRGB(90, 0, 160),
		ElementTransparency = 0.95,
		ToggleSlider = Color3.fromRGB(140, 0, 220),
		ToggleToggled = Color3.fromRGB(240, 200, 255),
		...
		Dialog = Color3.fromRGB(0, 0, 0),
		DialogHolder = Color3.fromRGB(0, 0, 0),
		DialogHolderLine = Color3.fromRGB(50, 0, 100),
		DialogButton = Color3.fromRGB(50, 0, 90),
		DialogButtonBorder = Color3.fromRGB(90, 0, 130),
...
Components.Element = (function()
	...
	return function(Title, Desc, Parent, Hover, Options)
		...
		Element.TitleLabel = New("TextLabel", {
			FontFace = Font.new("rbxasset://fonts/families/HighwayGothic.json", Enum.FontWeight.Medium, Enum.FontStyle.Normal),
			Text = Title,
