...
local Themes = {
	...
	LycHubv1 = {
		...
		AcrylicMain = Color3.fromRGB(0, 0, 0),
		AcrylicBorder = Color3.fromRGB(40, 0, 80),
		AcrylicGradient = ColorSequence.new(Color3.fromRGB(15, 0, 30), Color3.fromRGB(0, 0, 0)),
		AcrylicNoise = 1,
		TitleBarLine = Color3.fromRGB(50, 0, 100),
		Tab = Color3.fromRGB(90, 0, 160),
		Element = Color3.fromRGB(50, 0, 90),
		ElementBorder = Color3.fromRGB(97, 0, 143),
		InElementBorder = Color3.fromRGB(97, 0, 143),
		ElementTransparency = 0.95,
		ToggleSlider = Color3.fromRGB(140, 0, 220),
		ToggleToggled = Color3.fromRGB(128, 0, 189),
		SliderRail = Color3.fromRGB(170, 0, 240),
		DropdownFrame = Color3.fromRGB(70, 0, 120),
		DropdownHolder = Color3.fromRGB(0, 0, 0),
		DropdownBorder = Color3.fromRGB(170, 0, 240),
		DropdownOption = Color3.fromRGB(140, 0, 220),
		Keybind = Color3.fromRGB(140, 0, 220),
		Input = Color3.fromRGB(140, 0, 220),
		InputFocused = Color3.fromRGB(0, 0, 0),
		InputIndicator = Color3.fromRGB(180, 0, 250),
		InputIndicatorFocus = Color3.fromRGB(240, 200, 255),
		Dialog = Color3.fromRGB(0, 0, 0),
		DialogHolder = Color3.fromRGB(0, 0, 0),
		DialogHolderLine = Color3.fromRGB(97, 0, 143),
		DialogButton = Color3.fromRGB(50, 0, 90),
		DialogButtonBorder = Color3.fromRGB(97, 0, 143),
		DialogBorder = Color3.fromRGB(97, 0, 143),
		DialogInput = Color3.fromRGB(50, 0, 90),
		DialogInputLine = Color3.fromRGB(97, 0, 143),
		Text = Color3.fromRGB(240, 240, 240),
		SubText = Color3.fromRGB(170, 170, 170),
